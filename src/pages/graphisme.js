          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                ...
                summary="Création d'une charte graphique d'un jeu vidéo (Onyria) durant une évaluation de compétence."
                img={proj1}
                link="https://www.artstation.com/artwork/eRWYJ6"
                github="https://www.artstation.com/artwork/eRWYJ6"
              />
            </div>
