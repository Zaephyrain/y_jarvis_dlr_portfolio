  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="mx-4" href="/watermelon" title="Watermelon" />
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/watermelon" title="Watermelon" />
